    ...
    <div class="product" v-for="product in products" :key="product.id">
      ...
      <div class="info">
        ...
        <div class="price">
          ...
          <div class="quantity">
            <button class="ui button primary" @click="decreaseProductCart(product.documentId)">-</button>
            <p>{{ product.quantity }}</p>
            <button class="ui button primary" @click="increaseProductCart(product.documentId)">+</button>
          </div>
        </div>
      </div>
    </div>
